                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align: left; text-indent: 10px">
                            <c:forTokens var="file" items="${notice.files}" delims=",">
                                <a href="">${fn: toUpperCase(file)}</a>
                            </c:forTokens>
                        </td>
                    </tr>
                    <tr class="content">
                        <td colspan="4">안녕하세요. ${notice.writerId}입니다.<div><br></div><div>${notice.content}</div><div><br></div><div><a href="http://www.newlecture.com/resource/spring2.zip"><b><u><font size="5" color="#dd8a00">예제 다운로드하기</font></u></b></a></div><div><br></div><div><br></div></td>
                    </tr>
                    </tbody>
                </table>
            </div>
